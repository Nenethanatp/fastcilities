...
function Modal({ children }) {
  ...
  return (
    <>
      {openModal && (
        <div
          className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full flex justify-center items-start bg-black/80 pt-[30px]"
          tabIndex={-1}
